    ...
    <nav id="sidebar">
        <div class="sidebar-brand">
            <div class="d-flex align-items-center gap-2">
                <div
                    style="width:36px;height:36px;background:var(--primary);border-radius:8px;display:flex;align-items:center;justify-content:center;">
    ...
    <script>
        ...
        document.addEventListener('submit', function (e) {
            ...
            $.blockUI({
                ...
                <div class="mt-3 fw-semibold" style="color:#1e293b;">${text}</div>
                </div>`,
                css: {
                    border: 'none', padding: '24px 32px', borderRadius: '12px', backgroundColor: '#fff',
                    boxShadow: '0 20px 50px rgba(0,0,0,.25)', width: 'auto', top: '40%', left: '50%', marginLeft: '-90px'
                },
